...
KeepAliveTimeout 60
		...
		<Item Name="dashboard" Type="Folder">
			<Item Name="DB DataType Custom.ctl" Type="VI" URL="../DB DataType Custom.ctl"/>
			<Item Name="Performance.vi" Type="VI" URL="../Performance.vi"/>
		...
		<Item Name="Vision" Type="Folder">
			<Item Name="Vision Setup.vi" Type="VI" URL="../Vision Setup.vi"/>
		...
		<Item Name="Support Code" Type="Folder">
			...
			<Item Name="button_pressed.vi" Type="VI" URL="../button_pressed.vi"/>
			<Item Name="loop timer.vi" Type="VI" URL="../loop timer.vi"/>
			<Item Name="first call.vi" Type="VI" URL="../first call.vi"/>
			<Item Name="Button_number.vi" Type="VI" URL="../Button_number.vi"/>
			<Item Name="PID Filter.vi" Type="VI" URL="../PID Filter.vi"/>
			<Item Name="joystick deadband.vi" Type="VI" URL="../joystick deadband.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="fg_typedef.ctl" Type="VI" URL="../fg_typedef.ctl"/>
			...
			<Item Name="vision enable.ctl" Type="VI" URL="../vision enable.ctl"/>
			<Item Name="vision data.ctl" Type="VI" URL="../vision data.ctl"/>
		</Item>
		<Item Name="functional globals" Type="Folder">
			<Item Name="vision" Type="Folder">
				<Item Name="vision data fg.vi" Type="VI" URL="../vision data fg.vi"/>
				<Item Name="vision_fg.vi" Type="VI" URL="../vision_fg.vi"/>
				<Item Name="vision_targets_to_track_fg.vi" Type="VI" URL="../vision_targets_to_track_fg.vi"/>
			</Item>
			<Item Name="dash" Type="Folder">
				<Item Name="dash vision fg.vi" Type="VI" URL="../dash vision fg.vi"/>
				<Item Name="dash_data_fg.vi" Type="VI" URL="../dash_data_fg.vi"/>
				<Item Name="performance fg.vi" Type="VI" URL="../performance fg.vi"/>
			</Item>
			<Item Name="states FG.vi" Type="VI" URL="../states FG.vi"/>
			<Item Name="shooter bias fg.vi" Type="VI" URL="../shooter bias fg.vi"/>
		</Item>
		<Item Name="drive" Type="Folder">
			<Item Name="balance.vi" Type="VI" URL="../balance.vi"/>
			<Item Name="complementary angle filter.vi" Type="VI" URL="../complementary angle filter.vi"/>
			...
			<Item Name="closed drive.vi" Type="VI" URL="../closed drive.vi"/>
		</Item>
		<Item Name="turret" Type="Folder">
			<Item Name="turret.vi" Type="VI" URL="../turret.vi"/>
			<Item Name="aim.vi" Type="VI" URL="../aim.vi"/>
			<Item Name="turret speed.vi" Type="VI" URL="../turret speed.vi"/>
			<Item Name="motor safety.vi" Type="VI" URL="../motor safety.vi"/>
			<Item Name="turret limit.vi" Type="VI" URL="../turret limit.vi"/>
			<Item Name="calc shooter speed.vi" Type="VI" URL="../calc shooter speed.vi"/>
			<Item Name="tweak shooter speed.vi" Type="VI" URL="../tweak shooter speed.vi"/>
			<Item Name="battery normalizer.vi" Type="VI" URL="../battery normalizer.vi"/>
			<Item Name="target weighting.vi" Type="VI" URL="../target weighting.vi"/>
			<Item Name="drive shooting normalizer.vi" Type="VI" URL="../drive shooting normalizer.vi"/>
		</Item>
		<Item Name="states" Type="Folder">
			<Item Name="wait.vi" Type="VI" URL="../wait.vi"/>
			<Item Name="belt_timing.vi" Type="VI" URL="../belt_timing.vi"/>
			<Item Name="null.vi" Type="VI" URL="../null.vi"/>
		</Item>
		<Item Name="autonomous" Type="Folder">
			<Item Name="Auto Loop 0.vi" Type="VI" URL="../Auto Loop 0.vi"/>
			<Item Name="Auto Loop 1.vi" Type="VI" URL="../Auto Loop 1.vi"/>
			<Item Name="Auto Loop 2.vi" Type="VI" URL="../Auto Loop 2.vi"/>
			<Item Name="Auto Loop 3.vi" Type="VI" URL="../Auto Loop 3.vi"/>
			<Item Name="Auto Loop 4.vi" Type="VI" URL="../Auto Loop 4.vi"/>
			<Item Name="Auto Loop 5.vi" Type="VI" URL="../Auto Loop 5.vi"/>
			<Item Name="autoSM.vi" Type="VI" URL="../autoSM.vi"/>
		</Item>
		<Item Name="I2C Accelerometer" Type="Folder">
		...
		<Item Name="WPILib Mod" Type="Folder">
			<Item Name="joystick_get_pressed.vi" Type="VI" URL="../joystick_get_pressed.vi"/>
			<Item Name="camera mjpeg.vi" Type="VI" URL="../camera mjpeg.vi"/>
			<Item Name="SimpleDriveMotors.vi" Type="VI" URL="../SimpleDriveMotors.vi"/>
			<Item Name="SimpleSetMotor.vi" Type="VI" URL="../SimpleSetMotor.vi"/>
			<Item Name="SimpleStandardArcadeDrive.vi" Type="VI" URL="../SimpleStandardArcadeDrive.vi"/>
			<Item Name="BuildCustomDashBoardData.vi" Type="VI" URL="../BuildCustomDashBoardData.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Auto Read.vi" Type="VI" URL="../Auto Read.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
